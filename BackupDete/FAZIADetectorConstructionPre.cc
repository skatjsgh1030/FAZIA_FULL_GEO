  ...
  for(G4int Tel = 0 ; Tel < 1 ; Tel++)
  {
	...
	{//1
	  ...
	  PhysicalDetector11[Tel] = new G4PVPlacement(Rot_1Si[Tel],
		  G4ThreeVector(1000*(TMath::Sin(Blktheta1))*TMath::Cos((Blkphi1/1.0))*mm, 1000*(TMath::Sin(Blktheta1))*TMath::Sin((Blkphi1/1.0))*mm, 1000*(TMath::Cos(Blktheta1))*mm).rotateZ(90*(Tel)*degree),
	  ...
	  PhysicalDetector12[Tel] = new G4PVPlacement(Rot_1Si[Tel],
		  G4ThreeVector(1000.625*(TMath::Sin(Blktheta1))*TMath::Cos((Blkphi1/1.0))*mm, 1000.625*(TMath::Sin(Blktheta1))*TMath::Sin((Blkphi1/1.0))*mm, 1000.625*(TMath::Cos(Blktheta1))*mm).rotateZ(90*(Tel)*degree),
	  ...
	  PhysicalDetector13[Tel] = new G4PVPlacement(Rot_1Si[Tel],
		  G4ThreeVector(1051.058*(TMath::Sin(Blktheta1))*TMath::Cos((Blkphi1/1.0))*mm, 1051.058*(TMath::Sin(Blktheta1))*TMath::Sin((Blkphi1/1.0))*mm, 1051.058*(TMath::Cos(Blktheta1))*mm).rotateZ(90*(Tel)*degree),
	...
	{//2
	  ...
	  PhysicalDetector21[Tel] = new G4PVPlacement(Rot_2Si[Tel],
		  G4ThreeVector(1000*(TMath::Sin(Blktheta2))*TMath::Cos(Blkphi2)*mm, 1000*(TMath::Sin(Blktheta2))*TMath::Sin(Blkphi2)*mm, 1000*(TMath::Cos(Blktheta2))*mm).rotateZ(90*(Tel)*degree),
	  ...
	  PhysicalDetector22[Tel] = new G4PVPlacement(Rot_2Si[Tel],
		  G4ThreeVector(1000.625*(TMath::Sin(Blktheta2))*TMath::Cos(Blkphi2)*mm, 1000.625*(TMath::Sin(Blktheta2))*TMath::Sin(Blkphi2)*mm, 1000.625*(TMath::Cos(Blktheta2))*mm).rotateZ(90*(Tel)*degree),
	  ...
	  PhysicalDetector23[Tel] = new G4PVPlacement(Rot_2Si[Tel],
		  G4ThreeVector(1051.058*(TMath::Sin(Blktheta2))*TMath::Cos(Blkphi2)*mm, 1051.058*(TMath::Sin(Blktheta2))*TMath::Sin(Blkphi2)*mm, 1051.058*(TMath::Cos(Blktheta2))*mm).rotateZ(90*(Tel)*degree),
	...
	{//3
	  ...
	  PhysicalDetector31[Tel] = new G4PVPlacement(Rot_3Si[Tel],
		  G4ThreeVector(1000*(TMath::Sin(Blktheta3))*TMath::Cos(Blkphi3)*mm, 1000*(TMath::Sin(Blktheta3))*TMath::Sin(Blkphi3)*mm, 1000*(TMath::Cos(Blktheta3))*mm).rotateZ(90*(Tel)*degree),
	  ...
	  PhysicalDetector32[Tel] = new G4PVPlacement(Rot_3Si[Tel],
		  G4ThreeVector(1000.625*(TMath::Sin(Blktheta3))*TMath::Cos(Blkphi3)*mm, 1000.625*(TMath::Sin(Blktheta3))*TMath::Sin(Blkphi3)*mm, 1000.625*(TMath::Cos(Blktheta3))*mm).rotateZ(90*(Tel)*degree),
	  ...
	  PhysicalDetector33[Tel] = new G4PVPlacement(Rot_3Si[Tel],
		  G4ThreeVector(1051.058*(TMath::Sin(Blktheta3))*TMath::Cos(Blkphi3)*mm, 1051.058*(TMath::Sin(Blktheta3))*TMath::Sin(Blkphi3)*mm, 1051.058*(TMath::Cos(Blktheta3))*mm).rotateZ(90*(Tel)*degree),
	...
	{//4
	  ...
	  PhysicalDetector41[Tel] = new G4PVPlacement(Rot_4Si[Tel],
		  G4ThreeVector(1000*(TMath::Sin(Blktheta4))*TMath::Cos((Blkphi4/1.0))*mm, 1000*(TMath::Sin(Blktheta4))*TMath::Sin((Blkphi4/1.0))*mm, 1000*(TMath::Cos(Blktheta4))*mm).rotateZ(90*(Tel)*degree),
	  ...
	  PhysicalDetector42[Tel] = new G4PVPlacement(Rot_4Si[Tel],
		  G4ThreeVector(1000.625*(TMath::Sin(Blktheta4))*TMath::Cos((Blkphi4/1.0))*mm, 1000.625*(TMath::Sin(Blktheta4))*TMath::Sin((Blkphi4/1.0))*mm, 1000.625*(TMath::Cos(Blktheta4))*mm).rotateZ(90*(Tel)*degree),
	  ...
	  PhysicalDetector43[Tel] = new G4PVPlacement(Rot_4Si[Tel],
		  G4ThreeVector(1051.058*(TMath::Sin(Blktheta4))*TMath::Cos((Blkphi4/1.0))*mm, 1051.058*(TMath::Sin(Blktheta4))*TMath::Sin((Blkphi4/1.0))*mm, 1051.058*(TMath::Cos(Blktheta4))*mm).rotateZ(90*(Tel)*degree),
	...
	Silicon_11VisAtt[Tel] = new G4VisAttributes(G4Colour(1.0,0.0,1.0));
	Silicon_11VisAtt[Tel]-> SetForceWireframe(true);
	logicalDetector11[Tel] -> SetVisAttributes (Silicon_11VisAtt[Tel]);

	Silicon_12VisAtt[Tel] = new G4VisAttributes(G4Colour(1.0,1.0,0.0));
	Silicon_12VisAtt[Tel] -> SetForceWireframe(true);
	logicalDetector12[Tel] -> SetVisAttributes (Silicon_12VisAtt[Tel]);

	CsIcrystal1VisAtt[Tel] = new G4VisAttributes(G4Colour(0.0,1.0,1.0));
	CsIcrystal1VisAtt[Tel] -> SetForceWireframe(true);
	logicalDetector13[Tel] -> SetVisAttributes (CsIcrystal1VisAtt[Tel]);
	//
	Silicon_21VisAtt[Tel] = new G4VisAttributes(G4Colour(1.0,0.0,1.0));
	Silicon_21VisAtt[Tel]-> SetForceWireframe(true);
	logicalDetector21[Tel] -> SetVisAttributes (Silicon_21VisAtt[Tel]);

	Silicon_22VisAtt[Tel] = new G4VisAttributes(G4Colour(1.0,1.0,0.0));
	Silicon_22VisAtt[Tel] -> SetForceWireframe(true);
	logicalDetector22[Tel] -> SetVisAttributes (Silicon_22VisAtt[Tel]);

	CsIcrystal2VisAtt[Tel] = new G4VisAttributes(G4Colour(0.0,1.0,1.0));
	CsIcrystal2VisAtt[Tel] -> SetForceWireframe(true);
	logicalDetector23[Tel] -> SetVisAttributes (CsIcrystal2VisAtt[Tel]);
	//
	Silicon_31VisAtt[Tel] = new G4VisAttributes(G4Colour(1.0,0.0,1.0));
	Silicon_31VisAtt[Tel]-> SetForceWireframe(true);
	logicalDetector31[Tel] -> SetVisAttributes (Silicon_31VisAtt[Tel]);

	Silicon_32VisAtt[Tel] = new G4VisAttributes(G4Colour(1.0,1.0,0.0));
	Silicon_32VisAtt[Tel] -> SetForceWireframe(true);
	logicalDetector32[Tel] -> SetVisAttributes (Silicon_32VisAtt[Tel]);

	CsIcrystal3VisAtt[Tel] = new G4VisAttributes(G4Colour(0.0,1.0,1.0));
	CsIcrystal3VisAtt[Tel] -> SetForceWireframe(true);
	logicalDetector33[Tel] -> SetVisAttributes (CsIcrystal3VisAtt[Tel]);
	//		
	Silicon_41VisAtt[Tel] = new G4VisAttributes(G4Colour(1.0,0.0,1.0));
	Silicon_41VisAtt[Tel]-> SetForceWireframe(true);
	logicalDetector41[Tel] -> SetVisAttributes (Silicon_41VisAtt[Tel]);

	Silicon_42VisAtt[Tel] = new G4VisAttributes(G4Colour(1.0,1.0,0.0));
	Silicon_42VisAtt[Tel] -> SetForceWireframe(true);
	logicalDetector42[Tel] -> SetVisAttributes (Silicon_42VisAtt[Tel]);

	CsIcrystal4VisAtt[Tel] = new G4VisAttributes(G4Colour(0.0,1.0,1.0));
	CsIcrystal4VisAtt[Tel] -> SetForceWireframe(true);
	logicalDetector43[Tel] -> SetVisAttributes (CsIcrystal4VisAtt[Tel]);
  }
  //}
  //}
